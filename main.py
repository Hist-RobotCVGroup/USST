...
import numpy as np
from dataset import get_suim_dataloader, get_deepfish_dataloader
...
class LearnableFDA(nn.Module):
    ...
    def forward(self, src_img, trg_img,strength=1.0):
        ...
        soft_mask_expanded = soft_mask.unsqueeze(1)  
        soft_mask_expanded = soft_mask_expanded.expand_as(amp_trg) 
